...
input_dm[2]="Zenodo/Qiime/185_eDNA_samples_Eukaryote-shallow_core_metrics_unweighted_UNIFRAC_distance_artefacts/185_unweighted_unifrac_distance_matrix.tsv"
...
# input_dm[4]="Zenodo/Qiime/190_18S_eDNA_samples_Eukaryote-shallow_core_metrics_non_phylogenetic_JAQUARD_distance_artefacts/190_jaccard_distance_matrix.tsv"
...
tmp_dm[2]="$TMPDIR/02_results_euk_asv00_shal_UNIF.tsv" 

# tmp_dm[3]="$TMPDIR/03_results_euk_asv00_deep_JAQU.tsv"
# tmp_dm[4]="$TMPDIR/07_results_euk_asv00_shal_JAQU.tsv" 

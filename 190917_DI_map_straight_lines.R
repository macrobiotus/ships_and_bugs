...
library("geosphere")     # curved lines on overview map
...
# 17.Sept 2019 - updated with shallow port set from
# /Users/paul/Documents/CU_combined/Github/500_80_get_mixed_effect_model_results.R 

smpld_PORT <- c("PH", "SW", "SY", "AD", "BT", "HN", "HT", "LB", "MI", 
...
save (smpld, file = 
  "/Users/paul/Documents/CU_combined/Zenodo/Display_Item_Development/190809_DI_map__sampled_ports_df.Rdata")
...
srout_all <- srout 
save (srout_all, file =
  "/Users/paul/Documents/CU_combined/Zenodo/Display_Item_Development/190809_DI_map__considered_routes.Rdata")
...
#' Saving for R 
save (us_world, file =
  "/Users/paul/Documents/CU_combined/Zenodo/Display_Item_Development/190809_DI_map__current_routes_sorted.Rdata")

#' Saving for humans and external viewers:
write_excel_csv (us_world, 
                 "/Users/paul/Documents/CU_combined/Zenodo/Display_Item_Development/190809_DI_map__current_routes_sorted.csv",

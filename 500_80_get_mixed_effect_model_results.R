...
if (length(args)==0) {
  ...
  args[3] <- get_path(args[1], args[2], "_collapsed_resposne_distance_matrix", ".csv")
  ...
  args[4] <- get_path(args[1], args[2],  "_model_data", ".csv")
  ...
  args[5] <- get_path(args[1], args[2], "_variables_by_ecoregion", ".pdf")
  ...
  args[6] = get_path(args[1], args[2], "_modelling_results", ".txt")
  ...
  #  type = "message", split = TRUE)` command,  
  args[7] = get_path(args[1], args[2], "_modelling_results", ".pdf")

...
if (length(args)==0) {
  ...
  args[4] <- get_path(args[1], args[2],  paste0("_model_data_", uniqstr), ".csv")
  ...
  args[5] <- get_path(args[1], args[2], paste0("_variables_by_ecoregion_", uniqstr), ".pdf")
  ...
  args[6] = get_path(args[1], args[2], paste0("_modelling_results_", uniqstr), ".txt")
  ...
  #  type = "message", split = TRUE)` command,  
  args[7] = get_path(args[1], args[2], paste0("_modelling_results_", uniqstr), ".pdf")
